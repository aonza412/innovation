        ...
        <center>
            ...
            <table class="table" id="mytable">
                <thead>
                    ...
                    <th><h5 align="center">ผู้รับคืน</h5></th>
                    <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <td><h5 align="center">{{ $data_borrow->name }}</h5></td>
                    <td><h5 align="center">{{ $data_borrow->first_name }}</h5></td>
                    <td><h5 align="center">{{ $data_borrow->phone }}</h5></td>
                    <td><h5 align="center">{{ $data_borrow-> date_start }}</h5></td>
                    <td><h5 align="center">{{ $data_borrow-> date_end }}</h5></td>
                    <td><h5 align="center">คืนอุปกรณ์แล้ว</h5></td>
                    <th><h5 align="center">{{ $data_borrow->admin_first_name }}</h5></th>
                    </tr>
                    <?php $i++; ?>
                    @endforeach
                </tbody>
